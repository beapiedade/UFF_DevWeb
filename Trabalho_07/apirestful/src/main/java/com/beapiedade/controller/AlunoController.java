...
public class AlunoController {
    ...
    @PostMapping
    public ResponseEntity<Aluno> incluir(@RequestBody @Valid Aluno aluno) {
        Aluno novoAluno = alunoRepository.save(aluno);
        return new ResponseEntity<>(novoAluno, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Aluno> alterar(@PathVariable Long id, @RequestBody @Valid Aluno detalhesAluno) {
